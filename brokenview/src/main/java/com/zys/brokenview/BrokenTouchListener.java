...
public class BrokenTouchListener implements View.OnTouchListener {
    ...
    public void breake(View v,int x,int y) {
...
//        if (config.region == null || config.region.contains((int) 400, (int) 500)) {
...
//        }
    ...
    public float getScreenWide(Context c) {
    ...
    public float getScreenHeight(Context c) {
        WindowManager wmManager = (WindowManager) c.getApplicationContext().getSystemService(Context.WINDOW_SERVICE);
