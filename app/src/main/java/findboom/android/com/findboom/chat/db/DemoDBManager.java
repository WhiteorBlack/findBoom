package findboom.android.com.findboom.chat.db;
...
import findboom.android.com.findboom.chat.db.InviteMessage.InviteMesageStatus;
...
public class DemoDBManager {
    ...
    private DemoDBManager(){
        dbHelper = DbOpenHelper.getInstance(FindBoomApplication.getInstance().getApplicationContext());
    }
