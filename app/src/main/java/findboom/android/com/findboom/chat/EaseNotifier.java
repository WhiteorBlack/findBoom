 ...
 */
package findboom.android.com.findboom.chat;
...
public class EaseNotifier {
    ...
    public synchronized void onNewMsg(EMMessage message) {
        ...
        if (!AppPrefrence.getIsPush(appContext)) {
            return;
        }
    ...
    protected void sendNotification(EMMessage message, boolean isForeground, boolean numIncrease) {
        ...
        try {
            ...
            if (notificationInfoProvider != null) {
                ...
                msgIntent = new Intent(appContext, FriendMessage.class);
            ...
            contentTitle = username + "发来消息";
            summaryBody = notifyText = ((EMTextMessageBody) message.getBody()).getMessage();
