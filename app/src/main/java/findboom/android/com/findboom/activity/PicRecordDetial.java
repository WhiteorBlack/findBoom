 ...
 * 我埋雷记录详情
 */
public class PicRecordDetial extends BaseFragmentActivity implements PopInterfacer {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pic_record_detial);
        initView();
        getBoomInfo();
    }
    ...
    private void initView() {
        ...
        int wide = (int) (Tools.getScreenWide(this) * 0.35);
        txtInfo = (TextView) findViewById(R.id.txt_info);
        imgPhoto = (ImageView) findViewById(R.id.img_pic);
