...
import findboom.android.com.findboom.adapter.SelectBoomPicAdapter;
 ...
 * TODO:
 */
public class SelectBoomPic extends PopupWindow {
    private View view;
    private RecyclerView recyclerView;
    private List dataList = new ArrayList();
    private SelectBoomPicAdapter selectAdapter;
    ...
    public SelectBoomPic(Context context) {
    ...
    private void initView() {
        ...
        if (selectAdapter == null)
            selectAdapter = new SelectBoomPicAdapter(dataList);
        ...
        selectAdapter.setOnItemClickListener(new BaseRecyAdapter.OnItemClickListener() {
            ...
            public void onItemClickListener(View view, int position) {
                ...
                if (popInterfacer != null)
                    popInterfacer.OnConfirm(2, bundle);
                dismiss();
            }
    ...
    public void setStrings(List data) {
        dataList.clear();
        dataList.addAll(data);
        selectAdapter.notifyDataSetChanged();
        Tools.debug(data.size() + "");
    }
}
